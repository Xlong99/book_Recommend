    ...
    <div class="container-fluid">
        ...
        <div>
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="/admin/orderList">借阅管理</a></li>
            </ul>
        ...
        <div class="pull-right">
            <form class="navbar-form navbar-left" role="search" action="/admin/queryOrder">
...
<div class="col-sm-10 col-md-offset-1">
    <div class="well">
        <table class="table table-hover table-bordered table-striped thead-inverse">
            ...
            <tbody>
            <%
                List<BorrowDTO> borrowDTOValidList= (List<BorrowDTO>)request.getAttribute("orderValidList");
               if (borrowDTOValidList!=null){
                   for (BorrowDTO borrowDTO:borrowDTOValidList){
            %>
            <tr>
                <td class="col-md-1"><%= borrowDTO.getUserId() %>
                </td>
            ...
            <hr>
            <%
                List<BorrowDTO> borrowDTODELETEDList=(List<BorrowDTO>)request.getAttribute("orderDeletedList");
                if (borrowDTODELETEDList!=null){
                    for (BorrowDTO borrowDTO:borrowDTODELETEDList){
            %>
            <tr>
                <td class="col-md-1"><%= borrowDTO.getUserId() %>
                </td>
