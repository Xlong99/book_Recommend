    ...
    <div class="well">
        <table class="table table-hover table-bordered table-striped">
            ...
            <tr>
                ...
                <td class="col-md-1"><img src="<% if (bookDTO.getPhotoUrl()!=null) out.print(bookDTO.getPhotoUrl()); else out.print("https://video-spring.oss-cn-beijing.aliyuncs.com/timg%20%281%29.gif");%>" rel="noreferrer" style="max-width: 135px;max-height: 200px;"></td>
                <!--TODO 后台控制字数-->
